...
class ResponseEntityAssertionsTest {
    ...
    private static final String JSON_BODY = "{ \"json\": [ { \"id\": \"2\", \"arrayA\": [ { \"id\": \"2\" }, { \"id\": \"1\", \"arrayB\": { } } ] } ]}";
    private static final String EQUIVALENT_JSON_BODY = formatJson(JSON_BODY);
    private static final String INCORRECT_JSON = "{ \"other\": [ \"id\": \"2\" ]}";
    ...
    void testHasAnyBodyCanFail() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(EMPTY_404_ENTITY).hasBody()).isInstanceOf(AssertionError.class);
    }

    @Test
    void testHasSpecificBodyCanFail() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(EMPTY_404_ENTITY).hasBody(0.0D)).isInstanceOf(AssertionError.class);
    }

    @Test
    void testHasJsonBodyCanFail() {
        softly.assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(JSON_CORRECT_ENTITY).hasJsonBody(EMPTY_STRING, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
        softly.assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(JSON_CORRECT_ENTITY).hasJsonBody(INVALID_JSON, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
        softly.assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(JSON_CORRECT_ENTITY).hasJsonBody(INCORRECT_JSON, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
        softly.assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(JSON_INCORRECT_ENTITY).hasJsonBody(JSON_BODY, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
        softly.assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(JSON_INVALID_ENTITY).hasJsonBody(JSON_BODY, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
    ...
    void testHasJsonBodyCanFailIfNoBody() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(EMPTY_404_ENTITY).hasJsonBody(EMPTY_STRING, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
    }

    @Test
    void testHasJsonBodyCanFailIfNonStringBody() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(LONG_BAD_ENTITY).hasJsonBody(EMPTY_STRING, JSONCompareMode.LENIENT))
                .isInstanceOf(AssertionError.class);
    }

    @Test
    void testHasStatusCanFail() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(EMPTY_404_ENTITY).hasStatus(HttpStatus.OK)).isInstanceOf(AssertionError.class);
    }

    @Test
    void testHasStatusValueCanFail() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(EMPTY_404_ENTITY).hasStatusValue(200)).isInstanceOf(AssertionError.class);
    }

    @Test
    void testAssertionCanFailIfActualIsNull() {
        assertThatThrownBy(() -> ResponseEntityAssertions.assertThat(NULL_ENTITY).doesNotHaveBody())
                .isInstanceOf(AssertionError.class)
