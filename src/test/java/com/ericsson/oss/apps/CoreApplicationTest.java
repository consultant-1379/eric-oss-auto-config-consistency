...
/**
 * Unit tests for {@link CoreApplication} class.
 */
@ActiveProfiles("test")
...
public class CoreApplicationTest {
    ...
    public void metrics_available() throws Exception {
        ...
        assertThat(response.getContentAsString()).contains("jvm_threads_states_threads");
    }
    ...
    public void actuator_available() throws Exception {
        ...
        val response = result.getResponse();
        assertThat(response).isNotNull();
        assertThat(StringUtils.countOccurrencesOf(response.getContentAsString(), "href")).isEqualTo(ACTUATOR_URI_EXPOSED);
    }
}
