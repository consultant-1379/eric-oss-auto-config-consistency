...
*/ -}}
{{- define "eric-oss-auto-config-consistency.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-auto-config-consistency.mergeAnnotations" -}}
  {{- include "eric-oss-auto-config-consistency.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-auto-config-consistency.mergeLabels" -}}
  {{- include "eric-oss-auto-config-consistency.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
